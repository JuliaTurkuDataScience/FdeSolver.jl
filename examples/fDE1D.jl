...
## Numerical solution
t, Yapp = FDEsolver(F, tSpan, y0, β, par, nc=4, StopIt = "Convergence", tol = 10e-8, itmax = 30)

t1, Yapp1 = FDEsolver(F, tSpan, y0, β, par, J = JacobF, nc= 4, StopIt = "Convergence", tol = 10e-8, itmax = 30)
