...
% FDE_PI1_Im  Solves, on the interval [t0,T], an initial value problem for 
%             a for a system D^alpha y = f(t,y) of differential equations  
%             of fractional order alpha > 0. Multi-order systems (MOS) are 
%             also possible, i.e. systems in which equations have different
%             order. 
%             When one or more of the equations are of integer order, to
%             avoid instability it is suggested that differential equations 
%             with integer order greater or equal than 2 are recast in
%             terms of systems of differential equations of lower order.
%             The system is solved by the implicit product-integration rule
%             of rectangular type with convergence order equal to 1.  
%
...
%
%  Revision: 1.1 - Date: September, 17 2018
%
